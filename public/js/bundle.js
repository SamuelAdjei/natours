...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FtdWVsMzAiLCJhIjoiY2syYmY0b2dpMDQzNDNqbWZsZmN3MWhkbyJ9.kuJpejMrYzshMCzPZ7gVQQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/samuel30/ckbd069cb1qeo1imbtnfci0bn',
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds to include the current location
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); // reloads the page
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  e.preventDefault(); // stops from loading any other page
  // VALUES
...
if (userPasswordForm) userDataForm.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirmt').value;
            _context.next = 7;
